...
\title{VEGA RESONANCE ETERNAL ERSTELLT: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA RESONANCE ETERNAL ERSTELLT'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
